...
For the latest eer file format, read the **EER File Format** document in this repository.
...
2. To generate a 64 bit Visual Studio solution, navigate to the *Build* directory:
    ...
    * For example: 
        > cmake ../ -DLIBTIFF_INCLUDE_DIR="C:\ProgramData\FEI\PackageCache\libraries\libtiff\libtiff-4.3.0.1-vc141\include" -DLIBTIFF_LIB_DIR="C:\ProgramData\FEI\PackageCache\libraries\libtiff\libtiff-4.3.0.1-vc141\lib\Debug64" -G="Visual Studio 15 2017" -A x64
